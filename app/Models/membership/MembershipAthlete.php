...
class MembershipAthlete extends Model
{
    protected $table = 'uq_membership_member';
    protected $primaryKey = 'id';
    protected $fillable = ['membership_type_id','start_date','end_date','created_by','updated_by'];
    ...
    {
        return $this->belongsTo('member\Member', 'member_id', 'id');
    }
