...
class EventTeamRegistrationStatus extends Model
{
    protected $table = 'uq_team_registration_status';
    protected $fillable = ['team_registration_id', 'status', 'changed_by', 'changed_at'];
    public $timestamps = false;

    public static $rules = array(
        'team_registration_id' => 'required',
        'status' => 'required'
    );

    public function eventTeamRegistration()
    {
        return $this->belongsTo('event\EventTeamRegistration', 'team_registration_id');
    }
