...
class EventEntryWeightController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails())
		{
			...
			try {
                $event = $this->eventEntryWeight->update($id, $input);
    ...
    public function destroy($id)
    {
        try {
            ...
            $this->eventEntryWeight->delete($id);
    ...
    {
        return $this->eventEntryWeight->getDatatableList($request);
    }

    public function getEntryWeightByEntryId()
    {
        $input = Input::all();
