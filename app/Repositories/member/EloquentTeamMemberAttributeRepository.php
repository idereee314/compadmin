...
use member\TeamMemberAttribute as TeamMemberAttribute;
...
class EloquentTeamMemberAttributeRepository implements TeamMemberAttributeRepository {

	public function all()
	{
		return TeamMemberAttribute::all();
	}

	public function allPaginate()
	{
		return TeamMemberAttribute::paginate(ConfigHelper::getConfigValueByCode('pagination_global_list'));
	}

	public function find($id)
	{
		return TeamMemberAttribute::find($id);
	}

	public function create($input)
	{
		$item = new TeamMemberAttribute;

    	$attributes = [
        	['id' => 1, 'name' => 'height', 'value' => $input['athlete_height'], 'sport_id' => 2],
        	['id' => 2, 'name' => 'weight', 'value' => $input['athlete_weight'], 'sport_id' => 2],
        	['id' => 3, 'name' => 'position', 'value' => $input['athlete_position'], 'sport_id' => 2],
        	['id' => 4, 'name' => 'sport_title', 'value' => $input['sport_rank'], 'sport_id' => 2],
        	['id' => 5, 'name' => 'jersey_number', 'value' => $input['jersey_number'], 'sport_id' => 2]
    	];
    	...
    	foreach ($attributes as $attribute) {
    	    ...
    	    $item->sport_id = $attribute['sport_id'];
    ...
    {
		$qry = TeamMemberAttribute::select('*');
