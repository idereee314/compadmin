                                    ...
                                    <table class="table table-hover table-bordered table-head-custom" id="event-team-registration-datatable">
                                        ...
                                        <thead>
                                            <tr> 
                                                ...
                                                <th class="text-center" style="color: #0f4b63;">{{trans('display.comp_place_number')}}</th>                                                                                       
                                        ...
                                        <tbody>
                                            @foreach($memberApprovedData as $memberDatas)
                                                <tr>
                                                    <td class="text-center border-right" style="color: #0f4b63;">{{ ++$loop->index }}</td>
                                                    <td class="text-center border-right" style="color: #0f4b63;"><strong>{{ $memberDatas->place_number }}</strong></td>  
