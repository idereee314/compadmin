        ...
        <div class="timer-section" id="timerSection">
            <div class="match-info">
                <div class="match-details" id="matchDetails">
                    <span class="marquee-content">{{ $bracket->entry->name }} ({{ $bracket->age->name }}) / {{ config('enums.gender_code')[$bracket->entry->gender_code] ?? '' }} / {{ $bracket->belt->name }}  / {{ $bracket->weight->weight }}KG</span>
                </div>
