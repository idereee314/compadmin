    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Тэмцээнд оролцох бүсний төрөл
                <span class="text-muted pt-2 font-size-sm d-block">Тэмцээнд оролцох боломжтой бүсний ангилал</span></h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" id="entry-add-belt">
                ...
                @forelse(@$configBelsts as $key => $group)
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="javascript:;" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-belt" data-beltid="{{$belt->id}}">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
...
$(".edit-belt").on('click', function(){
    var eventId = $("#event_id").val();
    var beltId = $(this).data("beltid");
    
	$.get('/event/entry/belt/'+beltId+'/edit?eventId=' + eventId, function( data ) {
		$('#eventEntryModal').modal();
		$('#eventEntryModal').on('shown.bs.modal', function(){
			$('#eventEntryModal .modal-content').html(data);
            $('.selectpicker').selectpicker();
