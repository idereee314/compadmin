    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Тэмцээнд оролцох төрлүүд 
                <span class="text-muted pt-2 font-size-sm d-block">Тэмцээнд оролцогчдын нас болон хүйснээс хамаарах төрөл</span></h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" id="entry-add">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center pr-0">
                                <a href="javascript:;" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-entry" data-entryid="{{ $entry->id }}">
                                ...
                                <a href="javascript:;" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-entry" data-entryid="{{ $entry->id }}">
                                    <span class="svg-icon svg-icon-md svg-icon-primary">
			...
			$('#create-event-config-entries-form').validate({
				...
				submitHandler: function(form) {
					$.ajax({
                        url: form.action,
						type: form.method,
						data: $(form).serialize()+'&event_id='+eventId,
...
$(".edit-entry").on('click', function(){
    ...
    $.get('/event/entry/'+entryId+'/edit', function( data ) {
        $('#eventEntryModal').modal();
        $('#eventEntryModal').on('shown.bs.modal', function(){
            $('#eventEntryModal .modal-content').html(data);
            $('.selectpicker').selectpicker();
