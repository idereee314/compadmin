<div class="tab-pane fade show active" id="kt_tab_pane_11_3" role="tabpanel" aria-labelledby="kt_tab_pane_11_3">
    ...
    <div class="form-group">
        <div class="float-left">
            <a href="#" class="btn btn-text-primary btn-light-primary font-weight-bold ml-2" id="entry-add-fee">{{trans('display.general_new')}}</a>
        </div>
        <div class="clearfix"></div>
    </div>
    <div class="table-responsive mb-20">
        @if($configEntriesFees->count() > 0)
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center pr-0">
                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3" onclick="updateRecord({{$fee->id}})">
                        ...
                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm" onclick="deleteRecord({{$fee->id}})">
                            <span class="svg-icon svg-icon-md svg-icon-primary">
...
function updateRecord(id){
    var eventId = $("#event_id").val();
	$.get('/event/entry/fee/'+id+'/edit?eventId=' + eventId, function( data ) {
		$('#eventEntryModal').modal();
		$('#eventEntryModal').on('shown.bs.modal', function(){
			$('#eventEntryModal .modal-content').html(data);
            $('#end_date').datepicker({
