    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Тэмцээнд оролцох хураамж
                <span class="text-muted pt-2 font-size-sm d-block">Тэмцээнд оролцох хураамж хугацаагаар</span></h3>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center pr-0">
                            ...
                            <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-fee" data-feeid="{{$fee->id}}">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
