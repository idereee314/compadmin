    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">Тэмцээнд оролцох нас
                <span class="text-muted pt-2 font-size-sm d-block">Тэмцээнд оролцох боломжтой насны ангилал</span></h3>
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
                <a href="javascript:;" class="btn btn-primary font-weight-bolder" id="entry-add-age">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center pr-0">
                            <a href="javascript:;" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3 edit-age" data-ageid="{{$age->id}}">
                            ...
                            <a href="javascript:;" class="btn btn-icon btn-light btn-hover-primary btn-sm delete-age" data-ageid="{{$age->id}}">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
...
$(".edit-age").on('click', function(){
    var eventId = $("#event_id").val();
    var ageId = $(this).data("ageid");

    $.get('/event/entry/age/'+ageId+'/edit?eventId=' + eventId, function( data ) {
		$('#eventEntryModal').modal();
		$('#eventEntryModal').on('shown.bs.modal', function(){
			$('#eventEntryModal .modal-content').html(data);
            $('.selectpicker').selectpicker();
