<form class="form" method="POST" id="update-event-entry-age-form" action="{{ route('event.entry.age.update', $eventEntryAge->id) }}">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select class="form-control selectpicker" data-live-search="true" data-size="7" name="entry_id" id="entry_id">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 col-lg-6">
                <input type="number" class="form-control" value="{{$eventEntryAge->start_age}}" min="1" autocomplete="off" name="start_age"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 col-lg-6">
                <input type="number" class="form-control" value="{{$eventEntryAge->end_age}}" min="1" autocomplete="off" name="end_age"/>
                <div class="error-here"></div>
            </div>
        </div>
