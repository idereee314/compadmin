<form class="form" method="POST" id="create-event-toplist-point-form" action="{{ route('event.toplist.point.store') }}">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9 col-lg-6">
                <input type="number" class="form-control" autocomplete="off" name="point" />
            </div>
        </div>
    </div>
