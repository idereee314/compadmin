...
<form class="form" method="POST" id="create-event-entry-weight-form" action="{{ route('event.entry.weight.store') }}">
    ...
    <div class="card-body">
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select class="form-control" data-live-search="true" data-size="7" name="entry_id" id="entry_id" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
