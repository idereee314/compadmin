<div class="card card-custom">
    <div class="card-header card-header-tabs-line">
        <div class="card-title">
            <h2 class="card-label" style="font-family: 'Times New Roman', serif;"><strong>{{ $eventTeamRegistration->team->name }} {{trans('display.general_team_athlete')}}</strong></h2>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-head-custom" id="event-team-member-registration-datatable">
                ...
                <button id="print" class="btn btn-light-warning btn-square rounded-right font-weight-bolder mb-4" data-registrationid="{{$eventTeamRegistration->id}}"><i class="fa fa-print"></i> {{trans('display.general_print')}} </button>
                ...
                <thead>
                    <tr>
                        <th>№</th>
                        <th class="min-w-250px text-center">{{trans('display.human_name')}}</th>
                        <th class="min-w-80px text-center">{{trans('display.comp_athlete_jersey_number')}}</th>
                        <th class="min-w-80px text-center">{{trans('display.comp_voll_rank')}}</th>
                        <th class="min-w-80px text-center">{{trans('display.comp_voll_role')}}</th>
                        <th class="min-w-50px text-center">{{trans('display.comp_athlete_height')}}</th>
                        <th class="min-w-50px text-center">{{trans('display.comp_athlete_weight')}}</th>
        ...
        <div class="row mt-3">
            <div class="col-md-4">
                @if (@$teamLeader)           
                    <div style="font-size:12px;">Багийн ахлагч: <strong>{{@$teamLeader->lastname}} {{ @$teamLeader->firstname }}</strong></div>
                @else
                    <div style="font-size:12px;">Багийн ахлагч: </div>
                @endif
                <div style="font-size:12px;">Багийн дасгалжуулагч: <strong></strong></div>
            </div>
            <div class="col-md-4">
                <div style="font-size:12px;">Багийн дундаж нас: <strong> {{@$teamAverageAge}}</strong></div>
                <div style="font-size:12px;">Багийн дундаж өндөр: <strong>{{@$teamAverageHeight == 0 ? '' : @$teamAverageHeight}}</strong></div>
            </div>
            <div class="col-md-4">
                <div style="font-size:12px;">Хувцасны өнгө: <strong></strong></div>
                <div style="font-size:12px;">Холбогдох дугаар:<strong> {{ @$teamLeader->contact_phone}}</strong></div>
            </div>
        </div>
    </div>
