                ...
                @foreach($eventTeamRegistration->teamathlete as $athlete)
                    ...
                    <!-- <strong>{{ Config::get("enums.team_lead")[@$athlete->is_team_lead] }}</strong> -->
                        ...
                        <td class="text-center border-right">
                            ...
                            <a class="btn btn-icon btn-light btn-hover-primary btn-sm mr-3 edit" href="javascript:;" data-registrationid="{{$athlete->id}}" title="{{trans('display.general_edit')}}"><i class="la la-edit"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
<script>    
    $('#team_athlete_add').on( 'click', function () {
        ...
        $.get('registration/team/member/create?event_id=' + eventId + '&team_id=' + teamId, showAddModal);
    });
    ...
    $('#event-team-registration-datatable tbody').on( 'click', 'tr td a.edit', function () {
        ...
        $.get('registration/team/'+id+'/edit?event_id=' + eventId + '&team_id=' + teamId + '&member_id=' + memberId, showEditModal);
    });
