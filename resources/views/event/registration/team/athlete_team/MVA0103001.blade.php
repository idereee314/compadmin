<div style="width:{{ $width }};height: 595px; margin:0 auto; background-color: white;border: black;border-width: 1px;padding: 20px;">
    ...
    <div class="table-responsive mt-2">
        <table width="100%" style="width:100%;" id="event-team-registration-datatable" border="1">
            @if(count($eventTeamRegistration->teamathlete) > 0)
                <thead>
                    <tr>
                        <th style="font-size:10px; font-weight: normal;" width="5px" class="text-center">№</th>
    ...
    <div class="row mt-3">
        ...
        <!-- <div class="mt-5 mx-5">
        	<a id="print" class="btn btn-primary font-weight-bold"  href="/event/registration/team/athlete_team/{{ $eventTeamRegistration->id }}/pdf" target="_blank">PDF рүү хөрвүүлэх</a>
        </div> -->
