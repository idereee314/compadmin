...
<form class="form" method="POST" id="create-event-registration-form" action="{{ route('event.registration.store') }}">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control form-control-lg" id="entry_id" name="entry_id" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
            </div>
        </div> 
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control form-control-lg" id="entry_age_id" name="entry_age_id" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
            </div>
        </div> 
