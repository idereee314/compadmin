...
<html lang="{{ app()->getLocale() }}">
	...
	<head><base href="">
        ...
        <title>@yield('title', 'Uniq Тэмцээн')</title>
    ...
    <body>
        ...
        {{-- <script src="{{asset('assets/js/plugins/custom/jquery/jquery-2.1.3.js')}}"></script>
        <script src="{{asset('assets/js/plugins/custom/jquery/jquery-3.3.1.js')}}"></script>
		...
		<script src="{{asset('assets/js/pages_metronic/widgets.js')}}"></script>
