<form class="form" id="edit-country-form" action="{{route('country.update', $country->id)}}"  method="POST">
    ...
    <div class="card-body m-4">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select class="form-control selectpicker" id="type" name="type" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
                    ...
                    <option value="{{ $key }}" {{ $country->type == $key ? 'selected' : '' }}>{{ $type }}</option>
                    @empty
                    @endforelse
                </select>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                ...
                <p class="form-control-plaintext text-muted">{{ @$country->organization->name }}</p>
                @endif
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="name" value="{{ $country->name }}"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
                <div class="error-here"></div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" name="name_en" value="{{ $country->name_en }}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
                <div class="error-here"></div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="number" class="form-control" min="1" max="5000" step="1" name="sort_order" value="{{ $country->sort_order }}"  data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
                <div class="error-here"></div>
            </div>
        </div> 
    </div>
