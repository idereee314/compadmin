<form class="form" id="edit-member-form" action="{{route('member.update', $member->id)}}"  method="POST">
    ...
    <div class="card-body m-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" autocomplete="off" name="lastname" value="{{ $member->firstname }}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
                <div class="error-here"></div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="email" class="form-control" autocomplete="off" name="email" value="{{ $member->email }}" data-rule-required="true" data-rule-email="true" data-msg-required="{{ trans('messages.validation_field_required') }}" data-msg-email="{{ trans('messages.validation_mail') }}" data-inputmask="'alias': 'email'"/>
                <div class="error-here"></div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input class="form-control" name="username" id="username" autocomplete="off" value="{{ $member->username }}" placeholder="{{trans('display.username')}}">
                <div class="error-here"></div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="number" class="form-control" name="phone_number" id="phone_number" autocomplete="off" value="{{ $member->phone_number }}" placeholder="{{trans('display.human_phone_number')}}">
                <div class="error-here"></div>
            </div>
        </div>
    </div>
