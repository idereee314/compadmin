            ...
            <div class="d-flex flex-column-fluid">
                ...
                <div class="container"> 
                        ...
                        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-2">
                                ...
                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                                    ...
                                    <li class="breadcrumb-item text-muted">
                                        <a href="/pastEvent" style="color: black;"><strong>Болж өнгөрсөн жюү жицүгийн тэмцээнүүд</strong></a>
                                    </li>
                                </ul>
                                <!--end::Breadcrumb-->
                            </div>
                    ...
                    <div class="d-flex justify-content-center mb-5">
                        <h1 class="text-center bold margin-bottom-xs-16 margin-bottom-sm-0" style="font-size: 4rem; color: #0f4b63;"><strong>Болж өнгөрсөн жюү жицүгийн тэмцээнүүд</strong></h1>
                    </div>
