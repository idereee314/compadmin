...
<form class="form" method="POST" id="edit-role-form" action="{{ route('role.update', $role->id) }}">
    ...
    <div class="card-body m-4">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" autocomplete="off" name="name" value="{{ @$role->name }}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" class="form-control" autocomplete="off" name="code" value="{{ @$role->code }}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}"/>
                <div class="error-here"></div>
            </div>
        </div>
                                    ...
                                    <div class="form-group" style="margin: 0">
                                        <div class="input-group input-group-solid">
                                            ...
                                            <div class="input-group-prepend">
                                                <input type="hidden" name="menus[{{ $key }}]" value="{{ @$roleMenus[$key] }}"/>
                                                <button type="button" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ @$roleMenus[$key] ? @Config::get('enums.permission_opration')[$roleMenus[$key]] : trans('display.general_operation') }}</button>
