<form method="POST" id="picture-type-edit-form" class="form-horizontal smart-form" action="{!! route('reference.picture.type.update', $pictureType->id) !!}">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input class="form-control" type="text" name="code" id="code" value="{{$pictureType->code}}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <textarea class="form-control" rows="4" cols="50" name="description" id="description">{{$pictureType->description}}</textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input class="form-control" type="text" name="height" id="height" value="{{$pictureType->height}}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
                    <div class="error-here"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input class="form-control" type="text" name="width" id="width" value="{{$pictureType->width}}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
                    <div class="error-here"></div>
                    <span class="text-muted help-block">{{trans('display.only_insert_number')}}</span>
                </div>
            </div>
                ...
                <div class="col-md-6 col-sm-6">
                    <select class="form-control" name="object_type" id="object_type" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
                        ...
                        @foreach(Config::get('smart.object_types') as $key => $value)
                            <option value="{{ $value }}" {{ @$pictureType->object_type == $value ? 'selected': '' }}>{{ $value }}</option>
                        @endforeach
                    </select>
                    <div class="error-here"></div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-10">
                    <input class="form-control" type="text" name="dir_url" id="dir_url" value="{{$pictureType->dir_url}}" data-rule-required="true" data-msg-required="{{ trans('messages.validation_field_required') }}">
                    <div class="error-here"></div>
