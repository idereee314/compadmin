            ...
            <div class="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <div class="topbar">
                            ...
                            <form>
                                <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(/assets/media/misc/bg-1.jpg)">
                                    <h4 class="d-flex flex-center rounded-top">
                                        <span class="text-white">Мэдэгдэл, мэдээ</span>
                                        <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2">5 шинэ</span>
                                    </h4>
                                </div>
                                    ...
                                    <div class="navi navi-hover scroll my-4 ps ps--active-y" data-scroll="true" data-height="300" data-mobile-height="200" style="height: 300px; overflow: hidden;">
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">IQ тест нэмэгдлээ</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">Шалгалт хуваарь гарлаа</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">Шинээр асуулт нэмэгдлээ</div>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">Асуултын төрөл нэмэгдлээ</div>
                                                    <div class="text-muted">5 hrs ago</div>
                                                </div>
                                            </div>
                                        </a>
                                        ...
                                        <a href="#" class="navi-item">
                                            <div class="navi-link">
                                                ...
                                                <div class="navi-text">
                                                    <div class="font-weight-bold">IQ тест хуваарьт өөрчлөлт </div>
                                                    <div class="text-muted">23 hrs ago</div>
                                                </div>
                                            </div>
                                        </a>
                    ...
                    <!--end::Notifications-->
                     ...
                     <!--begin::User-->
                    <div class="dropdown dropdown-inline" data-toggle="tooltip" data-placement="top">
                        <a href="#" class="d-flex align-items-center" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="text hidden-xs hidden-sm text-muted">{{ SmartHelper::getLoggedName() }}</span>
                        ...
                        <div class="dropdown-menu p-0 m-0 dropdown-menu-md dropdown-menu-right">
                            ...
                            <ul class="navi navi-hover">
                                <li class="navi-header font-weight-bold py-4">
                                    <span class="font-size-lg">{{trans('display.profile_title')}}</span>
                                    <i class="flaticon-user icon-md text-muted" data-placement="right"></i>
                                </li>
                                ...
                                <li class="navi-footer py-4">
                                    <a class="btn btn-clean font-weight-bold btn-sm" href="{{ route('system.logout') }}">
                                    <i class="flaticon-logout" ></i>{{trans('display.logout')}}</a>
                                </li>
                            </ul>
                            <!--end::Navigation-->
                        </div>
