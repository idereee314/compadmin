...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        <!--begin::Aside Menu-->
        <div class="aside aside-dark" id="kt_aside">
            <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                <!--begin::Logo-->
                <a href="{{route('home.index')}}" class="brand-logo">
                    <img alt="Logo" class="h-35px" src="{{asset('assets/media/logos/logo-default.png')}}" />
                </a>
                <!--end::Logo-->
            </div>
            ...
            <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                <!--begin::Menu Nav-->
                <ul class="menu-nav">
                    @foreach(@Config::get('smart.menu') as $keyParent => $menu)
                    @if((!empty(@$menu['children']) && array_intersect_key(@$menu['children'], Session::get('userMenus')) || (empty(@$menu['children']) && array_key_exists($keyParent, Session::get('userMenus')))))
                    <li class="menu-item {{ empty(@$menu['children']) ? '' : 'menu-item-submenu' }} {{ (empty(@$menu['children']) && Arr::get(@$menu, 'url') == $_SERVER['REQUEST_URI']) || (!empty(@$menu['children']) && in_array($_SERVER['REQUEST_URI'], array_column(@$menu['children'], 'url'))) ? 'menu-item-open' : '' }}" aria-haspopup="true" {{ empty(@$menu['children']) ? '' : 'data-menu-toggle="hover"' }}>
                        <a href="{{ @$menu['url'] ? $menu['url'] : 'javascript:;' }}" class="menu-link {{ empty(@$menu['children']) ? '' : 'menu-toggle' }}">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                @foreach(@$menu['children'] as $key => $childMenu)
                                @if(array_key_exists($key, Session::get('userMenus')))
                                <li class="menu-item {{ Arr::get(@$childMenu, 'url') == $_SERVER['REQUEST_URI'] ? 'menu-item-open': '' }}" aria-haspopup="true">
                                    <a href="{{ @$childMenu['url'] }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot">
                                            <span></span>
                                        </i>
                                        <span class="menu-text">{{ @$childMenu['label'] }}</span>
                                    </a>
                                </li>
                                @endif
                                @endforeach
