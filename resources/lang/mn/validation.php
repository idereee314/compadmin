...
return [
    ...
    */
    ...
    'required_without'     => 'Хэрэв :attribute талбарт утга оруулаагүй байна',
    'required_without_all' => ':values талбаруудын аль нэгэнд заавал утга оруулах шаардлагатай.',
    ...
    'unique'               => 'Оруулсан :attribute талбарын утга аль хэдий нь бүртгэгдсэн байна.',
    'uploaded'             => ':Attribute талбарт оруулсан файлыг хуулхад алдаа гарлаа.',
    'url'                  => ':Attribute зөв url хаяг оруулна уу.',
	'uuid'                 => 'The :attribute must be a valid UUID.',
	'required_must' => ":attribute оруулаагүй байна.",
	'required_connect' => ":attribute холбоогүй байна.",
    'over_valid_percentage' => ":attribute талбарт зөвшөөрсөн хувиас хэтэрсэн өөрчлөлт орсон байна.",
    'unique_register' => 'Оруулсан :attribute талбарын утга аль хэдий нь бүртгэгдсэн байна.',
    'unique_candidate' => 'Оруулсан :attribute талбарын утгааар аль хэдий нь оролцогч бүртгэгдсэн байна.',
    'required_unique_show_order' => 'Харах дараалал давхцаж байна.',
    'required_unique_cat_id' => 'Category id давхцаж байна.',
    'unique_code' => 'Код давхцаж байна.',
    'organization_information' => 'Зураг, Хаяг, Цагийн хуваарь, Холбоо барих зэрэг мэдээллүүдийг оруулна уу. /Зураг 3-аас доошгүй/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        'username' => trans('display.username'),
